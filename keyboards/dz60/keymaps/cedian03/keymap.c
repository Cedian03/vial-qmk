...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        LT(2, KC_ESC),  HR_A,    HR_S,    HR_D,    HR_F,    KC_G,    KC_H,    HR_J,    HR_K,    HR_L,    HR_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT, _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(3),
        KC_LCTL, KC_LGUI, KC_LALT,                   _______, KC_SPC,  _______,          _______, KC_RALT, _______, KC_RGUI, KC_RCTL
    ),
    ...
    LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RALT, KC_RALT, XXXXXXX, KC_RGUI, KC_RCTL
    ),
    ...
    LAYOUT(
        QK_BOOT, DF(0),   DF(1),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
